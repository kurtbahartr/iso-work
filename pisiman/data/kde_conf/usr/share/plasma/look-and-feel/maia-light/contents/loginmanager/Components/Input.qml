...
Column {
            ...
            states: [
                State {
                    ...
                    PropertyChanges {
                        ...
                        border.color: config.inputHoverBorderColor
                    }
                    PropertyChanges {
                        target: username
    ...
    Item {
        ...
        TextField {
            ...
            renderType: Text.QtRendering
            background: Rectangle {
                color: config.inputBackgroundColor || "#222222"
                //opacity: 0.2
                border.color: config.inputBorderColor || "transparent"
                border.width: 1
                radius: config.RoundCorners || 0
            }
            onAccepted: config.AllowBadUsernames == "false" ? sddm.login(username.text.toLowerCase(), password.text, sessionSelect.selectedSession) : sddm.login(username.text, password.text, sessionSelect.selectedSession)
    ...
    Item {
        ...
        Button {
            ...
            background: Rectangle {
                id: buttonBackground
                color: config.submitbackgroundColor                
                //opacity: 0.2
                radius: config.RoundCorners || 0
            }
            ...
            states: [
                ...
                State {
                    ...
                    PropertyChanges {
                        target: buttonBackground
                        color:config.inputHoverBorderColor
